...
function consultarMessage(){
    ...
    $.ajax({
        url:"http://129.151.120.159:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
            imprimirRespuesta3(respuesta);
        }
    })
}

function imprimirRespuesta3(respuesta){
...
function guardarMessage(){
    ...
    let var2 = {
        ...
        url:"http://129.151.120.159:8080/api/Message/save",
...
function actualizarMessage(idElemento){
    if ($("#messageText").val().length==0) {
        ...
        $.ajax({
            url:"http://129.151.120.159:8080/api/Message/update",
            type:"PUT",
            data:dataToSend,
...
function borrarMessage(idElemento){
    ...
    $.ajax({
        url:"http://129.151.120.159:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
